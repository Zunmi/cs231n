...
class FullyConnectedNet(object):
    ...
    def __init__(
        ...
        for i in range(self.num_layers):
            ...
            # If batch/layer normalization is used, initialize gamma and beta for hidden layers
    ...
    def loss(self, X, y=None):
        ...
        # Output layer
        W_last, b_last = self.params["W%d" % self.num_layers], self.params["b%d" % self.num_layers]
        scores, last_affine_cache = affine_forward(current_input, W_last, b_last)
        caches.append(last_affine_cache)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
